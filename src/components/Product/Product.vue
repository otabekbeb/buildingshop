...
import { Thumbs, EffectFade, FreeMode } from "swiper/modules";
...
<template>
  <div class="cartelement_top row">
    <div class="product_photo col-6 col-sm-12">
      <Swiper
        class="product_photo_slider_full"
        ...
        :modules="[Thumbs, EffectFade, FreeMode]"
      >
        <SwiperSlide
          v-for="image in [imageUrl]"
          @key="image"
          class="product_photo_slider_item swiper-slide"
        >
          <div
            class="product_photo_slider_item_photo"
      ...
      <Swiper
        class="product_photo_slider_smile_preview"
        spaceBetween="0"
        :freeMode="false"
        loop
        :speed="1200"
    ...
    <div class="product_content_inf col-6 col-sm-12">
      <div class="status">
      ...
      <div class="product_content_inf_b">
        <div class="btns">
          ...
          <!-- <span>Мин. заказ: 3 шт. = 64 577.87 р.Кратность отгрузки: 3ш</span> -->
        </div>
        <div class="prices">
  ...
  <div class="cartelement_tabs">
    <div class="cartelement_tab">
      <div
        class="cartelement_tab_item"
    ...
    <div class="cartelement_tab_content">
      <div
        class="cartelement_tab_content_item"
        :class="{ active: switcher === 1 }"
      >
        ...
        <div class="for_tables">
            <div class="for_table">
            <div class="for_table_1">
                <h3 class="size_for_media">Код</h3>
                <h3>С-000283647</h3>
            </div>
            </div>
            <div class="for_table">
            <div class="for_table_1">
                <h3 class="size_for_media">Бренд </h3>.
                <h3>FUBAG</h3>
            </div>
            </div>
            <div class="for_table">
            <div class="for_table_1">
                <h3 class="size_for_media">Артикул производителя </h3>
                <h3>014091</h3>
            </div>
            </div>
            <div class="for_table">
            <div class="for_table_1">
                <h3 class="size_for_media">Вес, кг</h3>
                <h3>0.009</h3>
            </div>
            </div>
            <div class="for_table">
            <div class="for_table_1">
                <h3 class="size_for_media">Страна происхождения</h3>
                <h3>КИТАЙ</h3>
            </div>
            </div>
            <div class="for_table">
            <div class="for_table_1">
                <h3 class="size_for_media">Напряжение холостого хода, В</h3>
                <h3>67</h3>
            </div>
            </div>
            <div class="for_table">
            <div class="for_table_1">
                <h3 class="size_for_media">Диапазон регулирования сварочного тока в режиме MMA, А</h3>
                <h3>10-200</h3>
            </div>
            </div>
            <div class="for_table">
        ...
        <h2>Комплектация</h2>
        <p>
          Сварочный полуавтомат – 1 шт.; Горелка 3 м – 1 шт.; Кабель заземления,
          медь 3 м – 1шт.; Кабель с электрододержателем, медь 1,6 м – 1 шт.;
          Газовый шланг 3 м – 1 шт.; Ролик 0,6-0,8 мм – 1 шт.
        </p>
        ...
        <p>
          ...
          равномерным. Anti Sticking (антиприлипание). Снижение сварочного тока
          для отделения залипшего электрода на изделии без повреждения обмазки.
          TIG Lift. Ручная сварка неплавящимся вольфрамовым электродом в среде
          защитного газа - аргона. Преимущественно используется для сварки
