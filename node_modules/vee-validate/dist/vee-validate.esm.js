...
function _useField(path, rules, opts) {
    ...
    if (syncVModel) {
        useVModel({ value, prop: syncVModel, handleChange, validateOnModelUpdate: !!(opts === null || opts === void 0 ? void 0 : opts.validateOnValueUpdate) });
    }
    /**
...
function useVModel({ prop, value, handleChange, validateOnModelUpdate }) {
    const vm = getCurrentInstance();
    /* istanbul ignore next */
    if (!vm || !prop) {
        if ((process.env.NODE_ENV !== 'production')) {
